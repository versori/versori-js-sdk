...
import type {
    ...
    ListPublicConnectorsData,
    ListPublicConnectorsError,
    ListPublicConnectorsResponse,
    ListConnectorsData,
    ListConnectorsError,
    ...
    UpdateConnectorTagsData,
    UpdateConnectorTagsError,
    UpdateConnectorTagsResponse,
    UpdateConnectorCategoriesData,
    UpdateConnectorCategoriesError,
    UpdateConnectorCategoriesResponse,
    UpsertAuthSchemeConfigData,
    UpsertAuthSchemeConfigError,
    UpsertAuthSchemeConfigResponse,
    DeleteAuthSchemeConfigData,
    DeleteAuthSchemeConfigError,
    DeleteAuthSchemeConfigResponse,
    InitialiseOauth2ConnectionData,
    InitialiseOauth2ConnectionError,
    ...
    CreateConnectorConnectionData,
    CreateConnectorConnectionError,
    ...
    CreateConnectorVersionData,
    CreateConnectorVersionError,
    CreateConnectorVersionResponse,
    ListConnectorVersionsData,
    ListConnectorVersionsError,
    ListConnectorVersionsResponse,
    GetConnectorVersionData,
    GetConnectorVersionError,
    GetConnectorVersionResponse,
    UpdateConnectorVersionData,
    UpdateConnectorVersionError,
    UpdateConnectorVersionResponse,
    DeleteConnectorVersionData,
    DeleteConnectorVersionError,
    DeleteConnectorVersionResponse,
    ImportPublicConnectorVersionData,
    ImportPublicConnectorVersionError,
    ImportPublicConnectorVersionResponse,
    PublishConnectorData,
    PublishConnectorError,
    PublishConnectorResponse2,
    UnpublishConnectorData,
    UnpublishConnectorError,
    UnpublishConnectorResponse2,
    GetActionsData,
    GetActionsError,
    GetActionsResponse,
    CreateActionData,
    ...
    CreateDefinitionsData,
    CreateDefinitionsError,
    CreateDefinitionsResponse,
    DeleteDefinitionsData,
    DeleteDefinitionsError,
    DeleteDefinitionsResponse,
    GetDefinitionData,
    GetDefinitionError,
    ...
    ListAuthSchemesData,
    ListAuthSchemesError,
    ListAuthSchemesResponse,
    GetProtocolUploadUrlData,
    GetProtocolUploadUrlError,
    GetProtocolUploadUrlResponse,
    CreateHttpConnectorData,
    CreateHttpConnectorError,
    CreateHttpConnectorResponse,
    ImportHttpConnectorVersionData,
    ImportHttpConnectorVersionError,
    ImportHttpConnectorVersionResponse,
    ImportHttpConnectorData,
    ImportHttpConnectorError,
    ImportHttpConnectorResponse,
    CreateBigQueryConnectorData,
    CreateBigQueryConnectorError,
    CreateBigQueryConnectorResponse,
    GetRawSchemaData,
    GetRawSchemaError,
    GetRawSchemaResponse,
} from './types.gen';
 ...
 *
 */
export const listPublicConnectors = <ThrowOnError extends boolean = false>(
    options?: Options<ListPublicConnectorsData, ThrowOnError>
) => {
    return (options?.client ?? client).get<ListPublicConnectorsResponse, ListPublicConnectorsError, ThrowOnError>({
        ...options,
        url: '/connectors',
    });
};
...
export const listConnectors = <ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).get<ListConnectorsResponse, ListConnectorsError, ThrowOnError>({
        ...options,
...
export const getConnector = <ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).get<GetConnectorResponse, GetConnectorError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const updateConnector = <ThrowOnError extends boolean = false>(
    options: Options<UpdateConnectorData, ThrowOnError>
) => {
    return (options?.client ?? client).put<UpdateConnectorResponse, UpdateConnectorError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}',
    });
};
 ...
 *
 */
export const updateConnectorTags = <ThrowOnError extends boolean = false>(
    options: Options<UpdateConnectorTagsData, ThrowOnError>
) => {
    return (options?.client ?? client).put<UpdateConnectorTagsResponse, UpdateConnectorTagsError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const updateConnectorCategories = <ThrowOnError extends boolean = false>(
    options: Options<UpdateConnectorCategoriesData, ThrowOnError>
) => {
 ...
 *
 */
export const upsertAuthSchemeConfig = <ThrowOnError extends boolean = false>(
    options: Options<UpsertAuthSchemeConfigData, ThrowOnError>
) => {
    return (options?.client ?? client).put<UpsertAuthSchemeConfigResponse, UpsertAuthSchemeConfigError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const deleteAuthSchemeConfig = <ThrowOnError extends boolean = false>(
    options: Options<DeleteAuthSchemeConfigData, ThrowOnError>
) => {
 ...
 *
 */
export const initialiseOauth2Connection = <ThrowOnError extends boolean = false>(
    options: Options<InitialiseOauth2ConnectionData, ThrowOnError>
) => {
 ...
 *
 */
export const createConnectorConnection = <ThrowOnError extends boolean = false>(
    options: Options<CreateConnectorConnectionData, ThrowOnError>
) => {
    return (options?.client ?? client).post<
        CreateConnectorConnectionResponse,
        CreateConnectorConnectionError,
...
export const updateConnection = <ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).put<UpdateConnectionResponse, UpdateConnectionError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/connections/{connection_id}',
    });
};
 ...
 *
 */
export const createConnectorVersion = <ThrowOnError extends boolean = false>(
    options: Options<CreateConnectorVersionData, ThrowOnError>
) => {
    return (options?.client ?? client).post<CreateConnectorVersionResponse, CreateConnectorVersionError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const listConnectorVersions = <ThrowOnError extends boolean = false>(
    options: Options<ListConnectorVersionsData, ThrowOnError>
) => {
    return (options?.client ?? client).get<ListConnectorVersionsResponse, ListConnectorVersionsError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions',
    });
};
 ...
 *
 */
export const getConnectorVersion = <ThrowOnError extends boolean = false>(
    options: Options<GetConnectorVersionData, ThrowOnError>
) => {
    return (options?.client ?? client).get<GetConnectorVersionResponse, GetConnectorVersionError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const updateConnectorVersion = <ThrowOnError extends boolean = false>(
    options: Options<UpdateConnectorVersionData, ThrowOnError>
) => {
    return (options?.client ?? client).put<UpdateConnectorVersionResponse, UpdateConnectorVersionError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions/{version}',
    });
};
 ...
 *
 */
export const deleteConnectorVersion = <ThrowOnError extends boolean = false>(
    options: Options<DeleteConnectorVersionData, ThrowOnError>
) => {
    return (options?.client ?? client).delete<
        DeleteConnectorVersionResponse,
        DeleteConnectorVersionError,
 ...
 *
 */
export const importPublicConnectorVersion = <ThrowOnError extends boolean = false>(
    options: Options<ImportPublicConnectorVersionData, ThrowOnError>
) => {
    return (options?.client ?? client).post<
        ImportPublicConnectorVersionResponse,
        ImportPublicConnectorVersionError,
 ...
 */
export const publishConnector = <ThrowOnError extends boolean = false>(
    options: Options<PublishConnectorData, ThrowOnError>
) => {
    return (options?.client ?? client).post<PublishConnectorResponse2, PublishConnectorError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const unpublishConnector = <ThrowOnError extends boolean = false>(
    options: Options<UnpublishConnectorData, ThrowOnError>
) => {
    return (options?.client ?? client).post<UnpublishConnectorResponse2, UnpublishConnectorError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const createAction = <ThrowOnError extends boolean = false>(
    options: Options<CreateActionData, ThrowOnError>
) => {
    return (options?.client ?? client).post<CreateActionResponse, CreateActionError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions/{version}/actions',
    });
};
...
export const getAction = <ThrowOnError extends boolean = false>(options: Options<GetActionData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetActionResponse, GetActionError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const updateAction = <ThrowOnError extends boolean = false>(
    options: Options<UpdateActionData, ThrowOnError>
) => {
    return (options?.client ?? client).put<UpdateActionResponse, UpdateActionError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions/{version}/actions/{action_name}',
    });
};
 ...
 *
 */
export const deleteAction = <ThrowOnError extends boolean = false>(
    options: Options<DeleteActionData, ThrowOnError>
) => {
    return (options?.client ?? client).delete<DeleteActionResponse, DeleteActionError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions/{version}/actions/{action_name}',
    });
};
...
export const getTriggers = <ThrowOnError extends boolean = false>(options: Options<GetTriggersData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetTriggersResponse, GetTriggersError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const createTrigger = <ThrowOnError extends boolean = false>(
    options: Options<CreateTriggerData, ThrowOnError>
) => {
    return (options?.client ?? client).post<CreateTriggerResponse, CreateTriggerError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions/{version}/triggers',
    });
};
...
export const getTrigger = <ThrowOnError extends boolean = false>(options: Options<GetTriggerData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetTriggerResponse, GetTriggerError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const updateTrigger = <ThrowOnError extends boolean = false>(
    options: Options<UpdateTriggerData, ThrowOnError>
) => {
    return (options?.client ?? client).put<UpdateTriggerResponse, UpdateTriggerError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions/{version}/triggers/{trigger_name}',
    });
};
 ...
 *
 */
export const deleteTrigger = <ThrowOnError extends boolean = false>(
 ...
 *
 */
export const getDefinitions = <ThrowOnError extends boolean = false>(
 ...
 *
 */
export const createDefinitions = <ThrowOnError extends boolean = false>(
    options: Options<CreateDefinitionsData, ThrowOnError>
) => {
    return (options?.client ?? client).post<CreateDefinitionsResponse, CreateDefinitionsError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions/{version}/definitions',
    });
};
 ...
 *
 */
export const deleteDefinitions = <ThrowOnError extends boolean = false>(
    options: Options<DeleteDefinitionsData, ThrowOnError>
) => {
    return (options?.client ?? client).delete<DeleteDefinitionsResponse, DeleteDefinitionsError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions/{version}/definitions',
    });
};
 ...
 *
 */
export const getDefinition = <ThrowOnError extends boolean = false>(
    options: Options<GetDefinitionData, ThrowOnError>
) => {
 ...
 *
 */
export const updateDefinition = <ThrowOnError extends boolean = false>(
    options: Options<UpdateDefinitionData, ThrowOnError>
) => {
    return (options?.client ?? client).put<UpdateDefinitionResponse, UpdateDefinitionError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions/{version}/definitions/{definition_name}',
    });
};
 ...
 *
 */
export const deleteDefinition = <ThrowOnError extends boolean = false>(
    options: Options<DeleteDefinitionData, ThrowOnError>
) => {
    return (options?.client ?? client).delete<DeleteDefinitionResponse, DeleteDefinitionError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connectors/{connector_id}/versions/{version}/definitions/{definition_name}',
    });
};
 ...
 *
 */
export const listProtocols = <ThrowOnError extends boolean = false>(
    options: Options<ListProtocolsData, ThrowOnError>
) => {
    return (options?.client ?? client).get<ListProtocolsResponse, ListProtocolsError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const listAuthSchemes = <ThrowOnError extends boolean = false>(
    options: Options<ListAuthSchemesData, ThrowOnError>
) => {
    return (options?.client ?? client).get<ListAuthSchemesResponse, ListAuthSchemesError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const getProtocolUploadUrl = <ThrowOnError extends boolean = false>(
    options: Options<GetProtocolUploadUrlData, ThrowOnError>
) => {
    return (options?.client ?? client).get<GetProtocolUploadUrlResponse, GetProtocolUploadUrlError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const createHttpConnector = <ThrowOnError extends boolean = false>(
    options: Options<CreateHttpConnectorData, ThrowOnError>
) => {
    return (options?.client ?? client).post<CreateHttpConnectorResponse, CreateHttpConnectorError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const importHttpConnectorVersion = <ThrowOnError extends boolean = false>(
    options: Options<ImportHttpConnectorVersionData, ThrowOnError>
) => {
    return (options?.client ?? client).post<
        ImportHttpConnectorVersionResponse,
        ImportHttpConnectorVersionError,
 ...
 *
 */
export const importHttpConnector = <ThrowOnError extends boolean = false>(
    options: Options<ImportHttpConnectorData, ThrowOnError>
) => {
    return (options?.client ?? client).post<ImportHttpConnectorResponse, ImportHttpConnectorError, ThrowOnError>({
        ...options,
        ...formDataBodySerializer,
        headers: {
            'Content-Type': null,
 ...
 *
 */
export const createBigQueryConnector = <ThrowOnError extends boolean = false>(
    options: Options<CreateBigQueryConnectorData, ThrowOnError>
) => {
    return (options?.client ?? client).post<
        CreateBigQueryConnectorResponse,
        CreateBigQueryConnectorError,
 ...
 * Get a Raw Schema
 */
export const getRawSchema = <ThrowOnError extends boolean = false>(
    options: Options<GetRawSchemaData, ThrowOnError>
) => {
    return (options?.client ?? client).get<GetRawSchemaResponse, GetRawSchemaError, ThrowOnError>({
        ...options,
