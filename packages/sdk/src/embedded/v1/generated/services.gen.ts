...
import type { ListHubsData, ListHubsError, ListHubsResponse, CreateHubData, CreateHubError, CreateHubResponse, GetHubData, GetHubError, GetHubResponse, CreateEndUserData, CreateEndUserError, CreateEndUserResponse, ListEndUsersData, ListEndUsersError, ListEndUsersResponse, GetEndUserData, GetEndUserError, GetEndUserResponse, CreateEndUserConnectionData, CreateEndUserConnectionError, CreateEndUserConnectionResponse, ListEndUserConnectionsData, ListEndUserConnectionsError, ListEndUserConnectionsResponse, CreateIntegrationData, CreateIntegrationError, CreateIntegrationResponse, ListIntegrationsData, ListIntegrationsError, ListIntegrationsResponse, DeleteIntegrationData, DeleteIntegrationError, DeleteIntegrationResponse, CreateHubConnectionTemplateData, CreateHubConnectionTemplateError, CreateHubConnectionTemplateResponse, ListIntegrationConnectionTemplatesData, ListIntegrationConnectionTemplatesError, ListIntegrationConnectionTemplatesResponse, UpdateIntegrationMetadataData, UpdateIntegrationMetadataError, UpdateIntegrationMetadataResponse, GetEndUserConnectionData, GetEndUserConnectionError, GetEndUserConnectionResponse, ListEndUserIntegrationsData, ListEndUserIntegrationsError, ListEndUserIntegrationsResponse, GetEmbeddedIntegrationData, GetEmbeddedIntegrationError, GetEmbeddedIntegrationResponse, InitialiseOauth2EmbeddedConnectionData, InitialiseOauth2EmbeddedConnectionError, InitialiseOauth2EmbeddedConnectionResponse, ListEndUserActivationsData, ListEndUserActivationsError, ListEndUserActivationsResponse, ActivateIntegrationData, ActivateIntegrationError, ActivateIntegrationResponse, GetActivationData, GetActivationError, GetActivationResponse, DeleteActivationData, DeleteActivationError, DeleteActivationResponse, HealthCheckError, HealthCheckResponse } from './types.gen';
 ...
 *
 */
export const listHubs = <ThrowOnError extends boolean = false>(options: Options<ListHubsData, ThrowOnError>) => { return (options?.client ?? client).get<ListHubsResponse, ListHubsError, ThrowOnError>({
    ...options,
 ...
 * Create a new Hub
 */
export const createHub = <ThrowOnError extends boolean = false>(options?: Options<CreateHubData, ThrowOnError>) => { return (options?.client ?? client).post<CreateHubResponse, CreateHubError, ThrowOnError>({
    ...options,
    url: '/hubs'
}); };
 ...
 *
 */
export const getHub = <ThrowOnError extends boolean = false>(options: Options<GetHubData, ThrowOnError>) => { return (options?.client ?? client).get<GetHubResponse, GetHubError, ThrowOnError>({
    ...options,
    url: '/hubs/{hub_id}'
}); };
 ...
 *
 */
export const createEndUserConnection = <ThrowOnError extends boolean = false>(options: Options<CreateEndUserConnectionData, ThrowOnError>) => { return (options?.client ?? client).post<CreateEndUserConnectionResponse, CreateEndUserConnectionError, ThrowOnError>({
    ...options,
 ...
 *
 */
export const listEndUserConnections = <ThrowOnError extends boolean = false>(options: Options<ListEndUserConnectionsData, ThrowOnError>) => { return (options?.client ?? client).get<ListEndUserConnectionsResponse, ListEndUserConnectionsError, ThrowOnError>({
    ...options,
    url: '/hubs/{hub_id}/users/{user_id}/connections'
}); };
 ...
 *
 */
export const deleteIntegration = <ThrowOnError extends boolean = false>(options: Options<DeleteIntegrationData, ThrowOnError>) => { return (options?.client ?? client).delete<DeleteIntegrationResponse, DeleteIntegrationError, ThrowOnError>({
    ...options,
 ...
 *
 */
export const createHubConnectionTemplate = <ThrowOnError extends boolean = false>(options: Options<CreateHubConnectionTemplateData, ThrowOnError>) => { return (options?.client ?? client).post<CreateHubConnectionTemplateResponse, CreateHubConnectionTemplateError, ThrowOnError>({
    ...options,
 ...
 *
 */
export const listIntegrationConnectionTemplates = <ThrowOnError extends boolean = false>(options: Options<ListIntegrationConnectionTemplatesData, ThrowOnError>) => { return (options?.client ?? client).get<ListIntegrationConnectionTemplatesResponse, ListIntegrationConnectionTemplatesError, ThrowOnError>({
    ...options,
    url: '/integrations/{integration_id}/connection-templates'
}); };
 ...
 *
 */
export const updateIntegrationMetadata = <ThrowOnError extends boolean = false>(options: Options<UpdateIntegrationMetadataData, ThrowOnError>) => { return (options?.client ?? client).put<UpdateIntegrationMetadataResponse, UpdateIntegrationMetadataError, ThrowOnError>({
    ...options,
 ...
 *
 */
export const getEndUserConnection = <ThrowOnError extends boolean = false>(options: Options<GetEndUserConnectionData, ThrowOnError>) => { return (options?.client ?? client).get<GetEndUserConnectionResponse, GetEndUserConnectionError, ThrowOnError>({
    ...options,
 ...
 *
 */
export const listEndUserIntegrations = <ThrowOnError extends boolean = false>(options: Options<ListEndUserIntegrationsData, ThrowOnError>) => { return (options?.client ?? client).get<ListEndUserIntegrationsResponse, ListEndUserIntegrationsError, ThrowOnError>({
    ...options,
 ...
 *
 */
export const getEmbeddedIntegration = <ThrowOnError extends boolean = false>(options: Options<GetEmbeddedIntegrationData, ThrowOnError>) => { return (options?.client ?? client).get<GetEmbeddedIntegrationResponse, GetEmbeddedIntegrationError, ThrowOnError>({
    ...options,
 ...
 *
 */
export const initialiseOauth2EmbeddedConnection = <ThrowOnError extends boolean = false>(options: Options<InitialiseOauth2EmbeddedConnectionData, ThrowOnError>) => { return (options?.client ?? client).post<InitialiseOauth2EmbeddedConnectionResponse, InitialiseOauth2EmbeddedConnectionError, ThrowOnError>({
    ...options,
 ...
 *
 */
export const listEndUserActivations = <ThrowOnError extends boolean = false>(options: Options<ListEndUserActivationsData, ThrowOnError>) => { return (options?.client ?? client).get<ListEndUserActivationsResponse, ListEndUserActivationsError, ThrowOnError>({
    ...options,
 ...
 *
 */
export const activateIntegration = <ThrowOnError extends boolean = false>(options?: Options<ActivateIntegrationData, ThrowOnError>) => { return (options?.client ?? client).post<ActivateIntegrationResponse, ActivateIntegrationError, ThrowOnError>({
    ...options,
    url: '/activations'
}); };
