...
import type {
    ...
    SetProjectVariablesSchemaError,
    SetProjectVariablesSchemaResponse,
    PatchProjectVariablesSchemaData,
    PatchProjectVariablesSchemaError,
    PatchProjectVariablesSchemaResponse,
    GetFilesData,
    GetFilesError,
    GetFilesResponse,
    UpdateFilesData,
    ...
    LinkConnectionToEnvironmentData,
    LinkConnectionToEnvironmentError,
    LinkConnectionToEnvironmentResponse,
    CreateEndUserData,
    CreateEndUserError,
    ...
    SetDynamicVariableData,
    SetDynamicVariableError,
    SetDynamicVariableResponse,
    ListUserActivationsData,
    ListUserActivationsError,
    ...
    GetActivationConnectionData,
    GetActivationConnectionError,
    ...
    ListEnvironmentConnectionsData,
    ListEnvironmentConnectionsError,
    ListEnvironmentConnectionsResponse,
    LinkSystemData,
    LinkSystemError,
    LinkSystemResponse,
    ListProjectSystemsData,
    ListProjectSystemsError,
    ListProjectSystemsResponse,
    UnlinkSystemData,
    UnlinkSystemError,
    UnlinkSystemResponse,
    CreateConnectionTemplateData,
    CreateConnectionTemplateError,
    CreateConnectionTemplateResponse,
    ListProjectConnectionTemplatesData,
    ListProjectConnectionTemplatesError,
    ListProjectConnectionTemplatesResponse,
    DeleteConnectionTemplateData,
    DeleteConnectionTemplateError,
    DeleteConnectionTemplateResponse,
    UpdateConnectionTemplateData,
    UpdateConnectionTemplateError,
    UpdateConnectionTemplateResponse,
 ...
 *
 */
export const setProjectVariablesSchema = <ThrowOnError extends boolean = false>(
    options: Options<SetProjectVariablesSchemaData, ThrowOnError>
) => {
 ...
 *
 */
export const patchProjectVariablesSchema = <ThrowOnError extends boolean = false>(
    options: Options<PatchProjectVariablesSchemaData, ThrowOnError>
) => {
...
export const updateFiles = <ThrowOnError extends boolean = false>(options: Options<UpdateFilesData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateFilesResponse, UpdateFilesError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/projects/{project_id}/files',
    });
};
...
export const deployProject = <ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).put<DeployProjectResponse, DeployProjectError, ThrowOnError>({
        ...options,
...
export const getProjectLogs = <ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).get<GetProjectLogsResponse, GetProjectLogsError, ThrowOnError>({
        ...options,
 ...
 */
export const suspendProject = <ThrowOnError extends boolean = false>(
    options: Options<SuspendProjectData, ThrowOnError>
) => {
    return (options?.client ?? client).post<SuspendProjectResponse, SuspendProjectError, ThrowOnError>({
        ...options,
...
export const listConnections = <ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).get<ListConnectionsResponse, ListConnectionsError, ThrowOnError>({
        ...options,
...
export const createConnection = <ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).post<CreateConnectionResponse, CreateConnectionError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/connections',
    });
};
 ...
 *
 */
export const linkConnectionToEnvironment = <ThrowOnError extends boolean = false>(
    options: Options<LinkConnectionToEnvironmentData, ThrowOnError>
) => {
 ...
 *
 */
export const listAutomations = <ThrowOnError extends boolean = false>(
    options: Options<ListAutomationsData, ThrowOnError>
) => {
    return (options?.client ?? client).get<ListAutomationsResponse, ListAutomationsError, ThrowOnError>({
        ...options,
 ...
 */
export const createAutomation = <ThrowOnError extends boolean = false>(
    options: Options<CreateAutomationData, ThrowOnError>
) => {
    return (options?.client ?? client).post<CreateAutomationResponse, CreateAutomationError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/automations',
    });
};
 ...
 * Run an Automation
 */
export const runAutomation = <ThrowOnError extends boolean = false>(
    options: Options<RunAutomationData, ThrowOnError>
) => {
    return (options?.client ?? client).post<RunAutomationResponse, RunAutomationError, ThrowOnError>({
        ...options,
...
export const getAutomation = <ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? client).get<GetAutomationResponse, GetAutomationError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const listActivations = <ThrowOnError extends boolean = false>(
    options: Options<ListActivationsData, ThrowOnError>
) => {
    return (options?.client ?? client).get<ListActivationsResponse, ListActivationsError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const setDynamicVariable = <ThrowOnError extends boolean = false>(
    options: Options<SetDynamicVariableData, ThrowOnError>
) => {
    return (options?.client ?? client).put<SetDynamicVariableResponse, SetDynamicVariableError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const listUserActivations = <ThrowOnError extends boolean = false>(
    options: Options<ListUserActivationsData, ThrowOnError>
) => {
    return (options?.client ?? client).get<ListUserActivationsResponse, ListUserActivationsError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const deleteEndUser = <ThrowOnError extends boolean = false>(
    options: Options<DeleteEndUserData, ThrowOnError>
) => {
    return (options?.client ?? client).delete<DeleteEndUserResponse, DeleteEndUserError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/users/{user_id}',
    });
};
 ...
 */
export const getActivationConnection = <ThrowOnError extends boolean = false>(
    options: Options<GetActivationConnectionData, ThrowOnError>
) => {
    return (options?.client ?? client).get<GetActivationConnectionResponse, GetActivationConnectionError, ThrowOnError>(
        {
            ...options,
 ...
 * Create a new system.
 */
export const createSystem = <ThrowOnError extends boolean = false>(
    options: Options<CreateSystemData, ThrowOnError>
) => {
    return (options?.client ?? client).post<CreateSystemResponse, CreateSystemError, ThrowOnError>({
        ...options,
 ...
 */
export const listSystems = <ThrowOnError extends boolean = false>(options: Options<ListSystemsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListSystemsResponse, ListSystemsError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/systems',
    });
};
 ...
 * Update system.
 */
export const updateSystem = <ThrowOnError extends boolean = false>(
    options: Options<UpdateSystemData, ThrowOnError>
) => {
    return (options?.client ?? client).put<UpdateSystemResponse, UpdateSystemError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const listEnvironmentConnections = <ThrowOnError extends boolean = false>(
    options: Options<ListEnvironmentConnectionsData, ThrowOnError>
) => {
 ...
 */
export const linkSystem = <ThrowOnError extends boolean = false>(options: Options<LinkSystemData, ThrowOnError>) => {
    return (options?.client ?? client).post<LinkSystemResponse, LinkSystemError, ThrowOnError>({
        ...options,
 ...
 */
export const listProjectSystems = <ThrowOnError extends boolean = false>(
    options: Options<ListProjectSystemsData, ThrowOnError>
) => {
    return (options?.client ?? client).get<ListProjectSystemsResponse, ListProjectSystemsError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/projects/{project_id}/systems',
    });
};
 ...
 */
export const unlinkSystem = <ThrowOnError extends boolean = false>(
    options: Options<UnlinkSystemData, ThrowOnError>
) => {
    return (options?.client ?? client).delete<UnlinkSystemResponse, UnlinkSystemError, ThrowOnError>({
        ...options,
        url: '/o/{organisation_id}/projects/{project_id}/systems',
    });
};
 ...
 */
export const createConnectionTemplate = <ThrowOnError extends boolean = false>(
    options: Options<CreateConnectionTemplateData, ThrowOnError>
) => {
    return (options?.client ?? client).post<
        CreateConnectionTemplateResponse,
        CreateConnectionTemplateError,
 ...
 */
export const listProjectConnectionTemplates = <ThrowOnError extends boolean = false>(
    options: Options<ListProjectConnectionTemplatesData, ThrowOnError>
) => {
    return (options?.client ?? client).get<
        ListProjectConnectionTemplatesResponse,
        ListProjectConnectionTemplatesError,
 ...
 */
export const deleteConnectionTemplate = <ThrowOnError extends boolean = false>(
    options: Options<DeleteConnectionTemplateData, ThrowOnError>
) => {
    return (options?.client ?? client).delete<
        DeleteConnectionTemplateResponse,
        DeleteConnectionTemplateError,
 ...
 * Remove a system from a project environment
 */
export const updateConnectionTemplate = <ThrowOnError extends boolean = false>(
    options: Options<UpdateConnectionTemplateData, ThrowOnError>
) => {
    return (options?.client ?? client).put<
        UpdateConnectionTemplateResponse,
        UpdateConnectionTemplateError,
